...
namespace PodatkovniSloj.Modeli
{
    public partial class Matches
    {
        ...
        public string Location { get; set; } // -> stadioni
    ...
    public partial class Team
    {
        ...
        [JsonProperty("goals")]
        public long Goals { get; set; } // -> country - results
    ...
    public partial class TeamEvent
    {
        ...
        [JsonProperty("player")]
        public string Player { get; set; } // -> player - rank
    ...
    public partial class StartingEleven
    {
        ...
        public Image Picture { get; set; }  // Svakom igraču iz odabrane reprezentacije moguće je postaviti sliku.
    ...
    public enum Position { Defender, Forward, Goalie, Midfield }; // -> player pozicije
